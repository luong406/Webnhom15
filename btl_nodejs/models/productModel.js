...
const createProduct = (product_name, price, descrip, image, discount, quantity) => {
  return db.query(
    "INSERT INTO products(product_name, price, descrip, image, discount, quantity) VALUES(?, ?, ?, ?, ?, ?)",
    [product_name, parseInt(price), descrip, image, parseInt(discount), parseInt(quantity)]
  );
};
